...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //((TextView) findViewById(R.id.text_view)).setMovementMethod(LinkMovementMethod.getInstance());
        //((TextView) findViewById(R.id.text_view)).setText(Html.fromHtml(getResources().getString(R.string.string_with_links)));
                ...
                try {
                    /*String accessToken = GoogleAuthUtil.getToken(
                            getApplicationContext(),
                             person.getDisplayName(), "oauth2:https://www.googleapis.com/auth/plus.login");
                    //notifyServerGoogleAccountSignedIn(accessToken);*/
                    //+ Scopes.PLUS_LOGIN + " " + Scopes.PLUS_LOGIN
                    /*String ss = "audience.server:client_id:"+getString(R.string.server_client_id);
                    String accessToken = GoogleAuthUtil.getToken(getApplicationContext(),person.getDisplayName() ,ss);*/

                   // Log.i(TAG, "Display accessToken: " + accessToken);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                if (person != null) {
                    Log.i(TAG, "-------------IdToken-------------------"+result.getSignInAccount().getIdToken());
        ...
        client.newCall(request).enqueue(new okhttp3.Callback() {
            ...
            public void onResponse(okhttp3.Call call, okhttp3.Response response) throws IOException {
                try {
                    ...
                    System.out.println("fullJson-------------"+resp);
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            editText.setText("https://www.googleapis.com/plus/v1/people/me?access_token="+mAccessToken);
                            ((TextView) findViewById(R.id.text_view)).setMovementMethod(LinkMovementMethod.getInstance());
                            ((TextView) findViewById(R.id.text_view)).setText(Html.fromHtml("<a href=\"https://www.googleapis.com/plus/v1/people/me?access_token="+mAccessToken+"\">Google Token</a>"));
...
/*
            ...
            RequestBody requestBody =  new FormBody.Builder() //new FormEncodingBuilder()
                    .add("grant_type", "authorization_code")
                    .add("client_id", "818349321824-fa25cdurubc10k7ere1li4e5a6dj6dbv.apps.googleusercontent.com")
                    .add("client_secret", "r7uOxuyzwd-jBz31cdh0kfXM")
                    .add("redirect_uri", "")
